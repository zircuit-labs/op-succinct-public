...
sol! {
    ...
    contract OPSuccinctL2OutputOracle {
        ...
        function proposeL2OutputV3(bytes32 _outputRoot, uint64 _claimNonce, address _claimSenderAddress, uint256 _l2BlockNumber, uint256 _l1BlockNumber, bytes memory _proof, address _proverAddress)
        external
        payable
        whenNotOptimistic;
    }
