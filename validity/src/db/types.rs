...
pub struct OPSuccinctRequest {
    ...
    pub cost_exec_timeout_secs: Option<i64>,
    ...
    pub preroot: Option<Vec<u8>>,
    pub postroot: Option<Vec<u8>>,
    pub contract_root: Option<Vec<u8>>,
    pub max_exec_timeout_retries: Option<i64>,
}
...
impl OPSuccinctRequest {
    ...
    pub fn new_range_request(
        ...
        Self {
            ...
            preroot,
            postroot,
            max_exec_timeout_retries: Some(max_exec_timeout_retries),
            ..Default::default()
        }
    }
    ...
    pub fn new_agg_request(
        ...
        tracing::info!(
            "Creating new new_agg_request with preroot: {:?}, postroot: {:?}, contract_root: {:?}",
            preroot,
            postroot,
            contract_root
        );

        // TODO: Add proper calculation of total_nb_transactions for agg requests
        ...
        Self {
            ...
            preroot: Some(preroot.to_vec()),
            postroot: Some(postroot.to_vec()),
            contract_root: Some(contract_root.to_vec()),
            ..Default::default()
        }
    }
}
