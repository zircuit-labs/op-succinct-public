...
pub enum ProofRequesterError {
    /// Generic unhandled error for anyhow
    #[error(transparent)]
    ...
    #[error("Witness generation timeout")]
    WitnessGenTimeout,

    #[error("Metadata computation timeout")]
    MetadataComputeTimeout,

    #[error("Total instruction count is {0}")]
    InstructionCountTooLarge(u64),

    #[error("Instruction count: {0}, derivation count: {1}")]
    InstructionCountSmallerThanDerivation(u64, u64),
}
