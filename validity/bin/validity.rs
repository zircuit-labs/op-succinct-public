...
async fn main() -> Result<()> {
    ...
    let proposer_config = RequesterConfig {
        ...
        max_new_ranges_per_iteration: env_config.max_new_ranges_per_iteration,
        ...
        fork_start_block: env_config.fork_start_block,
        force_start_block: env_config.force_start_block,
        skip_aggregation_proofs: env_config.force_start_block.is_some(),
        submission_interval: env_config.submission_interval,
        max_aggregated_ranges: env_config.max_aggregated_ranges,
        cost_estimator_timeout_secs: env_config.cost_estimator_timeout_secs,
        witness_gen_timeout_secs: env_config.witness_gen_timeout_secs,
        max_exec_timeout_retries: env_config.max_exec_timeout_retries,
        mock: env_config.mock,
        prover_address: env_config.prover_address,
        safe_db_fallback: env_config.safe_db_fallback,
        high_memory_threshold: env_config.high_memory_threshold,
        instruction_count_limit: env_config.instruction_count_limit,
        split_on_timeout: env_config.split_on_timeout,
        set_for_upgrade: env_config.set_for_upgrade,
        proof_request_client: env_config.proof_request_client,
    };
